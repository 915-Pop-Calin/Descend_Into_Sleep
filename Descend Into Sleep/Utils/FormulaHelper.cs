...
namespace ConsoleApp12.Utils
{
    ...
    {
        private static double GetTheoreticalPercentage(int actsLeft, int totalActs, double epsilon = 0.125,
        ...
        public static double GetAttackValueDifference(int actsLeft, int totalActs, double attackValue)
        {
